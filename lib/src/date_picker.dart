...
///   * [textStartSelect], the label for the start date text input field.
///   * [textEndSelect], the label for the end date text input field.
///
/// An optional [locale] argument can be used to set the locale for the date
/// picker. It defaults to the ambient locale provided by [Localizations].
///
...
Future<DateTimeRange?> showDateRangePickerCustom({
  ...
  String? cancelText,
  String? confirmText,
  required String textStartSelect,
  required String textEndSelect,
  String? saveText,
  String? errorFormatText,
  String? errorInvalidText,
  ...
  Widget dialog = DateRangePickerDialog(
    ...
    firstDate: firstDate,
    lastDate: lastDate,
    textStartSelect: textStartSelect,
    textEndSelect: textEndSelect,
    currentDate: currentDate,
    initialEntryMode: initialEntryMode,
    helpText: helpText,
    cancelText: cancelText,
...
/// (i.e. 'Jan 21, 2020').
String _formatRangeStartDate(MaterialLocalizations localizations, DateTime? startDate, DateTime? endDate, String textStarSelect) {
...
String _formatRangeEndDate(MaterialLocalizations localizations, DateTime? startDate, DateTime? endDate, DateTime currentDate, String textEndSelect) {
  return endDate == null
    ? textEndSelect
...
class DateRangePickerDialog extends StatefulWidget {
  ...
  const DateRangePickerDialog({
    ...
    this.cancelText,
    this.confirmText,
    required this.textStartSelect,
    required this.textEndSelect,
    this.saveText,
  ...
  /// If null, the localized value of [MaterialLocalizations.dateRangeEndLabel]
  /// is used.
  final String textStartSelect;

  /// Texto fecha final.
  ///
  /// If null, the localized value of [MaterialLocalizations.dateRangeEndLabel]
  /// is used.
  final String textEndSelect;
    ...
    switch (_entryMode.value) {
      ...
      case DatePickerEntryMode.calendarOnly:
        contents = _CalendarRangePickerDialog(
          key: _calendarPickerKey,
          textStartSelect: widget.textStartSelect,
          textEndSelect: widget.textEndSelect,
...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String startDateText = _formatRangeStartDate(localizations, selectedStartDate, selectedEndDate,textStartSelect);
    final String endDateText = _formatRangeEndDate(localizations, selectedStartDate, selectedEndDate, DateTime.now(),textEndSelect);
...
class _InputDateRangePickerDialog extends StatelessWidget {
  ...
  String _formatDateRange(BuildContext context, DateTime? start, DateTime? end, DateTime now) {
    final MaterialLocalizations localizations = MaterialLocalizations.of(context);
    final String startText = _formatRangeStartDate(localizations, start, end,textStartSelect);
    final String endText = _formatRangeEndDate(localizations, start, end, now,textEndSelect);
